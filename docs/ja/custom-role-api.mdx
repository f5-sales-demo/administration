...
このガイドでは、F5 Distributed Cloudにおいて、HTTP Load Balancerで使用されるSSL/TLS証明書および証明書チェーンの管理権限を付与するカスタムRBACロールの作成手順を説明します。UIベースのアプローチについては、[簡易コンソールガイド](./custom-role-ui)をご覧ください。
