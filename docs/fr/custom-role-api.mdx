...
[guide simplifié de la console](/administration/fr/custom-role-ui/).
...
2. **`api_group`** — Une collection nommée de références `api_group_element`,
   ...
   supprimer ces objets. Les groupes utilisent des conventions de nommage comme `ves-io-proxy-read` ou
...
## Étape 1 : Découvrir les groupes API proxy
...
routes, certificats, chaînes de certificats, etc.), pas seulement les certificats. F5 XC
