...
[simplified console guide](/administration/en/custom-role-ui/).
...
| ------ | ---- | ----------- |
| POST | `/api/web/custom/namespaces/system/roles` | Create a custom role |
| GET | `/api/web/custom/namespaces/system/roles` | List custom roles |
...
| GET | `/api/web/namespaces/system/roles` | List roles |
...
| Method | Path | Description |
| ------ | ---- | ----------- |
| GET | `/api/web/namespaces/shared/api_groups` | List all api_groups |
| GET | `/api/web/namespaces/shared/api_group_elements` | List all api_group_elements |
